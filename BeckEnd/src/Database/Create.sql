...
CREATE TABLE TB_AGENDAMENTO (AgendamentoId					INT IDENTITY PRIMARY KEY
							...
							,AGEND_StatusPagamento			VARCHAR(10)     NOT NULL DEFAULT ("PENDENTE")
							,AGEND_FormaPagamento			VARCHAR(10)     NULL
...
CREATE TABLE TB_HOARARIO_TRABALHO (HorarioId 		INT 		IDENTITY PRIMARY KEY
								  ,BarbeiroId		INT 		NOT NULL

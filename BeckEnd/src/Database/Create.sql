CREATE TABLE TB_CLIENTES(ClienteId         INT             IDENTITY PRIMARY KEY  
...
CREATE TABLE TB_BARBEIROS (BarbeiroId     INT   IDENTITY PRIMARY KEY
...
CREATE TABLE TB_AGENDAMENTOS (AgendamentoId					INT IDENTITY PRIMARY KEY
							 ...
							 ,CONSTRAINT FK_AGENDAMENTO_CLIENTE  FOREIGN KEY (ClienteId)  REFERENCES TB_CLIENTES(ClienteId)
							 ,CONSTRAINT FK_AGENDAMENTO_SERVICO  FOREIGN KEY (ServicoId)  REFERENCES TB_SERVICO(ServicoId)
							 ,CONSTRAINT FK_AGENDAMENTO_BARBEIRO FOREIGN KEY (BarbeiroId) REFERENCES TB_BARBEIROS(BarbeiroId)

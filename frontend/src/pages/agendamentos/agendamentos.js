            ...
            <form onSubmit={handleSubmit}>
              ...
              <div className="form-grid">
                ...
                <div className="form-group-inline">
                  ...
                  <input type="date" name="dataAgendada" value={formData.dataAgendada} onChange={handleChange} required />
                </div>
                  ...
                  <div className="modal-body">
                    ...
                    <div className="form-row">
                      <div className="form-group">
                        ...
                        <input type="date" id="dataAgendada" name="dataAgendada" value={formData.dataAgendada} onChange={handleChange} required />
                      </div>
              ...
              <div className="modal-content modal-confirmacao" onClick={(e) => e.stopPropagation()}>
                ...
                <div className="modal-body-confirmacao">
                  ...
                  <div className="info-agendamento">
                    ...
                    <strong>Data/Hora:</strong> {formatarDataHora(agendamentoParaExcluir.AG_DataHoraInicio)}<br/>
